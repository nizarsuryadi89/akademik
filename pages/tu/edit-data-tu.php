<?php
	$kode 		= $_GET['idtu'];
	$tampil		= $con->query("select * from tbl_tu a inner join
                               tbl_tahun b on a.tmt=b.tahun_id inner join 
                                tbl_pendidikan c on a.tu_pendidikan =c.pendidikan_id inner join tbl_jabatan d on a.jabatan_id=d.jabatan_id
                                where tu_id = $kode");
	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			<div class="panel-heading">
				<a href="?page=Data Tenaga Kependidikan"><button class="btn btn-default"><i class="glyphicon glyphicon-chevron-left"></i>Kembali Ke Data Tenaga Kependidikan</button></a>
				...
				<div class="form-group">
					...
					<div class="col-md-6">
							<div class="form-group">
			                  ...
			                  <input type="number" name="nuptk" class="form-control" id="nuptk" value="<?php echo"$aa[tu_nuptk]"; ?>">
			              	</div>
			              	<div class="form-group">
			                  <label class="control-label" for="nip">NIY</label>
			                  <input type="text" name="nip" class="form-control" id="nip" value="<?php echo"$aa[tu_nip]"; ?>">
			              	</div>
			              	<div class="form-group">
			                  <label class="control-label" for="nama">Nama Lengkap</label>
			                  <input type="text" name="nama" class="form-control" id="nama" value="<?php echo"$aa[tu_nama]"; ?>">
			              	</div>
			              	<div class="form-group">
			                  <label class="control-label" for="tempat">Tempat Lahir</label>
			                  <input type="text" name="tempat" class="form-control" id="tempat" value="<?php echo"$aa[tu_tempatlahir]"; ?>">
			              	</div>
			              	<div class="form-group">
			                  <label class="control-label" for="tanggal">Tanggal Lahir</label>
			                  <input type="date" name="tanggal"  class="form-control" id="tanggal" value="<?php echo"$aa[tu_tgllahir]"; ?>">
			              	</div>
			              	<div class="form-group">
			                  ...
			                  <textarea class="form-control" name="alamat" rows="8" id="alamat"><?php echo"$aa[tu_alamat]";?></textarea>
			              	</div>
			              	<div class="form-group">
			        		...
			        		<div class="form-group">
			                  <label class="control-label" for="foto">
			                  	<?php 
			                  		...
			                  		{
			                  		echo"<img src='../../assets/foto-guru/$aa[tu_foto]' class='img-rounded' width='140' height='170'> ";
			                  		}
			              		?>
			                  ...
			                  <input type="text" name="hp" class="form-control" id="hp" value="<?php echo"$aa[tu_hp]"; ?>">
			              	</div>
			              	<div class="form-group">
			                  <label class="control-label" for="email">Alamat Email</label>
			                  <input type="text" name="email" class="form-control" id="email" value="<?php echo"$aa[tu_email]"; ?>">
			              	</div>
			              	<div class="form-group">
			                  ...
			                  <input type="text" name="jurusan" class="form-control" id="jurusan" value="<?php echo"$aa[tu_jurusan]"; ?>">
			              	</div>
			              	<div class="form-group">
...
<?php
	...
	if(isset($_POST['btnUpload']))
	{
		...
		$edittu = $con->query("update tbl_tu set 
											tu_nuptk		=   '$nuptk',
											tu_nip 			=	'$nip',
											tu_nama			= 	'$nama',
											tu_tempatlahir 	=	'$tempat',
											tu_tgllahir		=	'$tanggal',
											tu_jk			=	'$jk',
											tu_alamat		=	'$alamat',
											agama_kode		=	'$agama',
											tu_pendidikan	=	'$pendidikanterakhir',
											tu_jurusan		=	'$jurusan',
											jabatan_id		=	'$jabatan',
											tu_hp 			=	'$hp',
											no_sk 			=	'$nosk',
			...
			echo"<meta http-equiv='refresh' content='0.2;?page=Data Tenaga Kependidikan'>";

		if($upload)
		{
			$editfoto = $con->query("update tbl_tu set 
											tu_foto			=	'$file'
										 where tu_id			=	 $kode
