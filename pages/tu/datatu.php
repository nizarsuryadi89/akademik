              ...
              <?php 
              	while ($aa=$datasiswa->fetch_array())
              	{
          	        ...
          	        <tr class='odd gradeX'>
          	            ...
          	            <td>
                          <div>
                                <img src='../../assets/foto-guru/$aa[tu_foto]'  class='img-rounded zoom' width='30' height='40'> - $aa[tu_nama]
                          </div>
                        </td>
          	            <td>$aa[tu_jk]</td>
                        ...
                        <td>$aa[tahun]</td>
          	            <td align='center'>
                              <a href='?page=Edit Data Tu&idtu=$aa[tu_id]' class='open_modal' id='$aa[tu_id]'> <span class='glyphicon glyphicon-edit'></a>
                                  &nbsp;
