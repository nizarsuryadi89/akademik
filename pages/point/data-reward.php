    ...
    <div class="col-lg-5">
        <div class="panel panel-default">
            <div class="panel-heading">
              <h5 class="panel-title">REWARD POINT</h5>
            </div>
            ...
            <div class="panel-body">
                <div class="table-responsive">
                    <?php
                    	...
                    	$datasiswa = $con->query("select * from tbl_prestasi");
                    ?>
                          ...
                          $no = 1;
                        	while ($aa=$datasiswa->fetch_array())
                        	{
                    	        ...
                    	        <tr class='odd gradeX'>
                                  ...
                                  <td><a href='?page=data-funisment&pelanggaran=$aa[pelanggaran_nama]&id=$aa[pelanggaran_id]'>$aa[pelanggaran_nama]</td>
          ...
          <div class="col-lg-7">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">Input Prestasi Siswa</h4>
                </div>
                ...
                ?>
                    ...
                    <table width="100%">
                        ...
                        <tr><td>Jenis Prestasi</td><td>:</td><td><input type='text' value="<?php echo "$pelanggaran";?>" class='form-control' readonly>
                            <input type='hidden' name='id' value="<?php echo "$id";?>" class='form-control' readonly>
                        <br></td></tr>
                        <tr><td>Tanggal Prestasi</td><td>:</td><td><input type='date' class='form-control' name='tanggal'><br></td></tr>
            ...
            <?php
                    if(isset($_POST['btnUpload']))
                    {
                        ...
                        @$simpan     = $con->query("insert into tbl_pointpelanggaran set 
                                                    ...
                                                    ");
                        echo"<meta http-equiv='refresh' content='0.2;?page=data-funisment'>";
                    }
                }
            ?>
        ...
        <div class="col-lg-7">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4 class="panel-title">Data Siswa Berprestasi</h4>
                </div>
                <div class="panel-body" >
                    <div class="table-responsive">
