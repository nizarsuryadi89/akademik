...
?>
    ...
    <div class="col-lg-13">
        <h1>Nilai<small>&nbsp;Transkrip Nilai</h1>
        <ol class="breadcrumb">
          <li><a href="#"><i class="icon-dashborad">Transkrip Nilai - NIS : <?php echo "$nis";?></a></i></li>
        </ol>
    </div>
	...
	<div class="col-lg-13">
		...
		<?php
			...
			if (@$_POST[simpan]=='simpan')
			{
				...
				echo"<meta http-equiv='refresh' content='0.2;?page=transkrip-nilai'>";
