			...
			echo"</table>";
				...
				if (@$_POST['save']=='save')
				{
					...
					if (($hadir <= 100) and ($nh1 <= 100) and ($uts <= 100) and ($uas <= 100))
					{
						...
						echo "<meta http-equiv='refresh' content='0.2;URL=?page=Input%20Nilai%20USBN&mapel-kd=$kode&rombel-kd=$rombel&kur_id=1'>";
					}
					else
					{
				...
				if (@$_POST[kirim]=='kirim') 
				{
					...
					elseif ($rs == '6')
					{
						...
						echo "<meta http-equiv='refresh' content='0.2;URL=?page=Input%20Nilai%20USBN&mapel-kd=$kode&rombel-kd=$rombel&kur_id=1&mapelrombel=$mapelkd'>";
