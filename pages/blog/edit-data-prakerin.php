<?php
	@$kode 		= $_GET['kode'];
	$tampil		= $con->query("select * from tbl_prakerin where prakerin_id=$kode");
			       		...
			       		<tr>
			       			<td colspan="2"><br>
				                  ...
				                  <label class="control-label" for="foto">
				                  	<?php 
				                  		if (@$aa[ppdb_fotosiswa]=='')
				                  		{
				                  		echo"<img src='../assets/foto-siswa/noimage.png' class='img-rounded' width='140' height='170'> ";
				                  		}
				                  		else
				                  		{
				                  		echo"<img src='../assets/foto-siswa/$aa[ppdb_fotosiswa]' class='img-rounded' width='140' height='170'> ";
				                  		}
				              		?>
				                  	Foto 3x4 Terbaru
				                  </label>
