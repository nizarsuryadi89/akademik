...
<?php 		
	if ($sms == 4)
	{
		$t_prakerin=$con->query("select tempat_prakerin,alamat_prakerin,nilai_prakerin from tbl_transkrip_sms4 a inner join tbl_siswa b on a.siswa_nis=b.siswa_nis where rombel_id = $rombel");	
		$pr = $t_prakerin->fetch_assoc();
	
	}
	elseif ($sms == 5)
	{
		$t_prakerin=$con->query("select tempat_prakerin,alamat_prakerin,nilai_prakerin from tbl_transkrip_sms5 a inner join tbl_siswa b on a.siswa_nis=b.siswa_nis where rombel_id = $rombel");	
		$pr = $t_prakerin->fetch_assoc();
...
<?php
	if ($sms == 1)
	{
		$t_ekskul=$con->query("SELECT ekskul1,ekskul2,ekskul3,catatan_walikelas,sakit,izin,alfa from tbl_transkrip_sms1 a inner join tbl_siswa b on a.siswa_nis=b.siswa_nis where (rombel_id = $rombel)");	
		$eks 	 = $t_ekskul->fetch_assoc();
	}
	elseif ($sms == 2)
	{
		$t_ekskul=$con->query("SELECT ekskul1,ekskul2,ekskul3,catatan_walikelas,sakit,izin,alfa from tbl_transkrip_sms2 a inner join tbl_siswa b on a.siswa_nis=b.siswa_nis where (rombel_id = $rombel)");	
		$eks 	 = $t_ekskul->fetch_assoc();
	
	}
	elseif ($sms == 3)
	{
		$t_ekskul=$con->query("SELECT ekskul1,ekskul2,ekskul3,catatan_walikelas,sakit,izin,alfa from tbl_transkrip_sms3 a inner join tbl_siswa b on a.siswa_nis=b.siswa_nis where (rombel_id = $rombel)");	
		$eks 	 = $t_ekskul->fetch_assoc();
	
	}
	elseif ($sms == 4)
	{
		$t_ekskul=$con->query("SELECT ekskul1,ekskul2,ekskul3,catatan_walikelas,sakit,izin,alfa from tbl_transkrip_sms4 a inner join tbl_siswa b on a.siswa_nis=b.siswa_nis where (rombel_id = $rombel)");	
		$eks 	 = $t_ekskul->fetch_assoc();
	
	}
	elseif ($sms == 5)
	{
		$t_ekskul=$con->query("SELECT ekskul1,ekskul2,ekskul3,catatan_walikelas,sakit,izin,alfa from tbl_transkrip_sms5 a inner join tbl_siswa b on a.siswa_nis=b.siswa_nis where (rombel_id = $rombel)");	
		$eks 	 = $t_ekskul->fetch_assoc();
	
	}
	elseif ($sms == 6)
	{
		$t_ekskul=$con->query("SELECT ekskul1,ekskul2,ekskul3,catatan_walikelas,sakit,izin,alfa from tbl_transkrip_sms6 a inner join tbl_siswa b on a.siswa_nis=b.siswa_nis where (rombel_id = $rombel)");	
		$eks 	 = $t_ekskul->fetch_assoc();
	}
...
if ($sms == 1)
	{
		$hadir=$con->query("select ekskul1,ekskul2,ekskul3, catatan_walikelas,sakit,izin,alfa from tbl_transkrip_sms1 a inner join tbl_siswa b on a.siswa_nis=b.siswa_nis where rombel_id = $rombel");	
		$hd 	 = $hadir->fetch_assoc();
	}
	elseif ($sms == 2)
	{
		$hadir=$con->query("select ekskul1,ekskul2,ekskul3,catatan_walikelas,sakit,izin,alfa from tbl_transkrip_sms2 a inner join tbl_siswa b on a.siswa_nis=b.siswa_nis where rombel_id = $rombel");	
		$hd 	 = $hadir->fetch_assoc();
	
	}
	elseif ($sms == 3)
	{
		$hadir=$con->query("select ekskul1,ekskul2,ekskul3,catatan_walikelas,sakit,izin,alfa from tbl_transkrip_sms3 a inner join tbl_siswa b on a.siswa_nis=b.siswa_nis where rombel_id = $rombel");	
		$hd 	 = $hadir->fetch_assoc();
	
	}
	elseif ($sms == 4)
	{
		$hadir=$con->query("SELECT ekskul1,ekskul2,ekskul3,catatan_walikelas,sakit,izin,alfa from tbl_transkrip_sms4 a inner join tbl_siswa b on a.siswa_nis=b.siswa_nis where (rombel_id = $rombel AND a.siswa_nis='$kode') limit 0,1");	
		$hd 	 = $hadir->fetch_assoc();
	
	}
	elseif ($sms == 5)
	{
		$hadir=$con->query("select ekskul1,ekskul2,ekskul3,catatan_walikelas,sakit,izin,alfa from tbl_transkrip_sms5 a inner join tbl_siswa b on a.siswa_nis=b.siswa_nis where rombel_id = $rombel");	
		$hd 	 = $hadir->fetch_assoc();
	
	}
	elseif ($sms == 6)
	{
		$hadir=$con->query("select ekskul1,ekskul2,ekskul3,catatan_walikelas,sakit,izin,alfa from tbl_transkrip_sms6 a inner join tbl_siswa b on a.siswa_nis=b.siswa_nis where rombel_id = $rombel");	
		$hd 	 = $hadir->fetch_assoc();
	}
...
<table class="table table-bordered">
	...
	<tr>
		<td width="100%" align="center"><p align="justify"><?php echo"$eks[catatan_walikelas]";?></p>
