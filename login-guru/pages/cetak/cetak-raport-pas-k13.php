...
?>
	...
	<div class="panel-heading">
		<a href="?page=cetak-raport"><button class="btn btn-success"><i class="fa fa-backward"></i></button>
		<?php echo "
		<a href='?page=cetak-raport-pas-sms1-k13&rombel=$rombel&nissiswa=$kode&semester=$semester'>
		";
		?>
	...
	<?php
		$semua = $con->query("select * from tbl_transkrip_sms3 where rombel_id=$rombel group by siswa_nis");
