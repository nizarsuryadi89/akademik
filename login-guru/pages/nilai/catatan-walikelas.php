					...
					while($row= $result->fetch_array())
				{
					echo"<tr>
						...
						<td>
							...
							<textarea class='form-control' name='alamat' cols='40'>$row[catatan_walikelas]</textarea>
						</td>
...
<?php
	if (@$_POST[save] == 'save')
	{
		...
		if ($semester == 1)
		{
			$editnilai 	= $con->query("update tbl_transkrip_sms1 set catatan_walikelas = '$tempat' where nilai_id = $id ");
			echo "<meta http-equiv='refresh' content='0.2;URL=?page=catatan-walikelas&semester=$semester&rombelid=$rombel'>";
		
		}elseif ($semester == 2)
		{
			$editnilai 	= $con->query("update tbl_transkrip_sms2 set catatan_walikelas = '$tempat' where nilai_id = $id ");
			echo "<meta http-equiv='refresh' content='0.2;URL=?page=catatan-walikelas&semester=$semester&rombelid=$rombel'>";
		
		}
		elseif ($semester == 3)
		{
			$editnilai 	= $con->query("update tbl_transkrip_sms3 set catatan_walikelas = '$tempat' where nilai_id = $id ");
			echo "<meta http-equiv='refresh' content='0.2;URL=?page=catatan-walikelas&semester=$semester&rombelid=$rombel'>";
		
		}
		elseif ($semester == 4)
		{
			$editnilai 	= $con->query("update tbl_transkrip_sms4 set catatan_walikelas = '$tempat' where nilai_id = $id ");

			//echo"update tbl_transkrip_sms4 set catatan_walikelas = '$tempat' where nilai_id = $id ";
			echo "<meta http-equiv='refresh' content='0.2;URL=?page=catatan-walikelas&semester=$semester&rombelid=$rombel'>";
		
		}
		elseif ($semester == 5)
		{
			$editnilai 	= $con->query("update tbl_transkrip_sms5 set catatan_walikelas = '$tempat' where nilai_id = $id ");
			echo "<meta http-equiv='refresh' content='0.2;URL=?page=catatan-walikelas&semester=$semester&rombelid=$rombel'>";
		
		}
		elseif ($semester == 6)
		{
			$editnilai 	= $con->query("update tbl_transkrip_sms6 set catatan_walikelas = '$tempat' where nilai_id = $id ");
			echo "<meta http-equiv='refresh' content='0.2;URL=?page=catatan-walikelas&semester=$semester&rombelid=$rombel'>";
