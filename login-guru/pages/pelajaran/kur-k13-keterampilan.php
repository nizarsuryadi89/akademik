	  ...
	  <?php echo"$aa[mapel_nama] - KKM: $aa[kkm] - $aa[guru_nama] "; ?> <br><br>
		...
		<?php																	
			while($row= $result->fetch_array())
			{
				...
				if (($nilaiakhir < 59.9) and ($nilaiakhir >= 1.0))
				{	@$predikat		="D";
