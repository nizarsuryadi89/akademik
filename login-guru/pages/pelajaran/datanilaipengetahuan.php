	...
	<div class="col-md-12">
		<div class="panel panel-primary">
			<div class="panel-heading">
				...
				<a href="?page=mapel-rombel&kd-rombel=<?php echo $rombel ; ?>"><button class="btn btn-default"><i class="glyphicon glyphicon-print"></i> Cetak Nilai</button></a>
				...
				<?php											
					...
					if ($_POST[kirim]=='kirim') 
					{
						...
						elseif ($rs == '2')
						{
							...
							if ($sms2 == '')
								{
									$save = $con->query("insert into tbl_transkrip set siswa_nis = '$nis', mapel_id = $kode,sms_2=$raport, kkm_sms2 = $kkm, rombel_id=$rombel");
								}
								else
								{
						...
						{				
							...
							if ($sms2 == '')
								{
									$save = $con->query("insert into tbl_transkrip set siswa_nis = '$nis', mapel_id = $kode,sms_3=$raport, kkm_sms3 = $kkm, rombel_id=$rombel");
								}
								else
								{
									$save = $con->query("update tbl_transkrip set 
						...
						elseif ($rs == '5')
						{
							if ($sms5 == '')
								{
									$save = $con->query("insert into tbl_transkrip set siswa_nis = '$nis', mapel_id = $kode,sms_5=$raport, kkm_sms5 = $kkm, rombel_id=$rombel");
								}
								else
								{
									$save = $con->query("update tbl_transkrip set 
